...
# another way to format the lm function, specifying a dataset first
irradiance.regression <- lm(data = PeterPaul.chem.nutrients, irradianceWater ~ depth)
summary(irradiance.regression)
# at a depth of 0, the predicted irradiance will be 486.81; R-Squared: our data explains 31% of the data. Adjusted R will penalting your more explatory variables. Compensating for degrees of freedom.
...
> ANSWER: The effect of depth on irradiance is significant. With 1 unit of depth go deep, the irrdiance will decrease 95.89 units.(linear regression; R2 = 0.31, df = 15449, p-value < 0.0001)
...
irradiancebydepth2 <- 
    ...
    labs(x=expression("Depth(m)"), y=expression("log water irradiance"))+
  #scale_x_continuous()
  #put the equation, geom_text
print(irradiancebydepth2)
