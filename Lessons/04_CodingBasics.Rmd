...
vector1[3] # call certain components, the 3rd element of vector1.

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # create a matrix with 1 through 20. automatically count by rows first.
matrix1
...
matrix1[4, ] #
matrix1[ , 3] #
matrix1[c(12, 14)] # the 12th and 14the element, counting by column.
matrix1[c(12:14)] #
matrix1[2:4, 1:3] #
