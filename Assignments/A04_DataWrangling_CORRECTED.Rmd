...
#4 Process data
EPA_Ozone_2017.data.AQI <- select(EPA_Ozone_2017.data, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPA_Ozone_2018.data.AQI <- select(EPA_Ozone_2018.data, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
EPA_total_Pollution.data.spread <- spread(EPA_total_Pollution.data.processed, AQS_PARAMETER_DESC, DAILY_AQI_VALUE)
#10
dim(EPA_total_Pollution.data.spread)
#11
write.csv(EPA_total_Pollution.data.spread, row.names = F, file = "../Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv.csv")
```
